...
## 🏫 Proyecto de Ingeniería de Software | Período Sep-Ene 2025-2026 UCAB

Este proyecto fue desarrollado en el marco de la asignatura **Ingeniería de Software** de la **UCAB**, bajo la dirección de la **Profesora María Angélica Pérez de Ovalles**.

Kálamo es un sistema integral de **gestión bibliotecaria** que busca modernizar el flujo de trabajo tanto para los usuarios como para el personal.

* **Para el Usuario (Lector):** Proporciona una interfaz intuitiva para explorar el catálogo 🔎, reservar 🗓️ y solicitar préstamos de forma ágil, reduciendo la dependencia directa del bibliotecario para consultas básicas.
...
Aquí se encuentran los enlaces a los documentos fundamentales que definen el alcance, los requisitos y la estructura de Sistema-Kálamo:
